...
function createEffectStyles() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Create Grid Styles
        const existingGridStyles = yield figma.getLocalGridStylesAsync();
        const gridStyles = [
...
function applyGridLayout(frame, gridType) {
    if (gridType === 'mobile') {
        frame.layoutGrids = [
            {
                pattern: 'COLUMNS',
...
function createGridExamples(page) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const gridTemplates = [
            // Mobile devices
            { name: 'Mobile / iPhone SE', width: 375, height: 667, type: 'mobile' },
            { name: 'Mobile / iPhone 12/13', width: 390, height: 844, type: 'mobile' },
            { name: 'Mobile / iPhone 14 Pro', width: 393, height: 852, type: 'mobile' },
            { name: 'Mobile / Android', width: 360, height: 800, type: 'mobile' },
            // Tablets
            { name: 'Tablet / iPad Mini', width: 768, height: 1024, type: 'mobile' },
            { name: 'Tablet / iPad Pro 11"', width: 834, height: 1194, type: 'desktop' },
            // Desktop
            { name: 'Desktop / Laptop', width: 1440, height: 900, type: 'desktop' },
...
function finalizeVariantSet(page, components, name, description, columns, cellW = 220, cellH = 72) {
...
// ============================================================================
function gen_button(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const sizes = [
...
function gen_toggle(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const states = ['off', 'on'];
        const variants = [
        ...
        for (const variant of variants) {
            for (const state of states) {
                ...
                text.characters = 'B';
                text.fontSize = 14;
                const fg = findVariable(state === 'on' ? 'accent-foreground' : 'foreground');
                if (fg)
                    text.fills = [varPaint(fg)];
                comp.appendChild(text);
                comps.push(comp);
...
function gen_toggle_group(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        items.forEach((it, i) => {
            ...
            if (border) {
                b.strokes = [varPaint(border)];
                b.strokeWeight = 1;
                b.strokeAlign = 'INSIDE';
                if (i > 0)
                    b.strokeLeftWeight = 0;
            }
            ...
            t.fontSize = 14;
            const fg = findVariable(it.on ? 'accent-foreground' : 'foreground');
            if (fg)
                t.fills = [varPaint(fg)];
            b.appendChild(t);
            comp.appendChild(b);
...
function gen_sonner(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Sonner';
        ...
        title.fontSize = 14;
        const tfg = findVariable('popover-foreground');
        if (tfg)
            title.fills = [varPaint(tfg)];
        const desc = figma.createText();
        desc.fontName = { family: 'Inter', style: 'Regular' };
        desc.characters = 'Monday, January 1 at 9:00 AM';
        desc.fontSize = 12;
        const dfg = findVariable('muted-foreground');
        if (dfg)
            desc.fills = [varPaint(dfg)];
        ...
        const abg = findVariable('primary');
        if (abg)
            action.fills = [varPaint(abg)];
        const at = figma.createText();
        at.fontName = { family: 'Inter', style: 'Medium' };
        at.characters = 'Undo';
        at.fontSize = 13;
        const afg = findVariable('primary-foreground');
        if (afg)
            at.fills = [varPaint(afg)];
        action.appendChild(at);
        comp.appendChild(action);
        page.appendChild(comp);
    });
}
function gen_button_group(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
...
function gen_input(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const states = [
...
function gen_textarea(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const states = [
...
function gen_checkbox(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
...
function gen_switch(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const trackWidth = 36;
...
function gen_slider(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (primaryVar)
            range.fills = [varPaint(primaryVar)];
        ...
        const bgVar = findVariable('background');
        if (bgVar)
            thumb.fills = [varPaint(bgVar)];
        if (primaryVar) {
            thumb.strokes = [varPaint(primaryVar)];
...
function gen_label(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Label';
...
function gen_radio_group(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const states = [
            { selected: false },
            { selected: true },
...
function gen_select(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Select';
        ...
        if (iconColor)
            icon.strokes = [varPaint(iconColor)];
        yield icon.setVectorNetworkAsync({
            vertices: [
...
function gen_native_select(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        if (inputBorder) {
            comp.strokes = [varPaint(inputBorder)];
            comp.strokeWeight = 1;
        }
        ...
        if (muted)
            chevron.strokes = [varPaint(muted)];
        icon.appendChild(chevron);
        comp.appendChild(icon);
        page.appendChild(comp);
    });
}
function gen_combobox(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Combobox';
...
function gen_date_picker(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        body.fills = [];
        if (mutedFg) {
            body.strokes = [varPaint(mutedFg)];
            body.strokeWeight = 1.4;
        }
        ...
        headerLine.y = 6;
        if (mutedFg)
            headerLine.fills = [varPaint(mutedFg)];
        ...
        if (mutedFg)
            postLeft.fills = [varPaint(mutedFg)];
        ...
        if (mutedFg)
            postRight.fills = [varPaint(mutedFg)];
        ...
        label.fontSize = 14;
        if (mutedFg)
            label.fills = [varPaint(mutedFg)];
        comp.appendChild(label);
        label.layoutGrow = 1;
        page.appendChild(comp);
    });
}
function gen_input_otp(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Input OTP';
        ...
        const fgVar = findVariable('foreground');
        const slotContents = ['1', '', '', '', '', ''];
        const makeGroup = (startIndex) => {
            ...
            for (let i = 0; i < 3; i++) {
                ...
                const strokeVar = isActive && ringVar ? ringVar : borderVar;
                if (strokeVar) {
...
function gen_field(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Field';
        ...
        if (inputBg)
            input.fills = [varPaint(inputBg)];
        const inputBorder = findVariable('input');
        if (inputBorder) {
            input.strokes = [varPaint(inputBorder)];
        ...
        if (placeholderFg)
            placeholder.fills = [varPaint(placeholderFg)];
        ...
        if (helperFg)
            helper.fills = [varPaint(helperFg)];
        comp.appendChild(helper);
        page.appendChild(comp);
    });
}
function gen_card(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Card';
        ...
        if (cardBg)
            comp.fills = [varPaint(cardBg)];
        const cardBorder = findVariable('border');
        if (cardBorder) {
            comp.strokes = [varPaint(cardBorder)];
            comp.strokeWeight = 1;
        }
        ...
        if (mutedFg)
            description.fills = [varPaint(mutedFg)];
        ...
        if (primaryFg)
            buttonText.fills = [varPaint(primaryFg)];
...
function gen_badge(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const variants = [
...
function gen_alert(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const variants = [
        ...
        for (const variant of variants) {
            ...
            stem.cornerRadius = 1;
            if (iconColorVar)
                stem.fills = [varPaint(iconColorVar)];
            ...
            dot.y = 10.5;
            if (iconColorVar)
                dot.fills = [varPaint(iconColorVar)];
            ...
            if (descFg)
                desc.fills = [varPaint(descFg)];
            textCol.appendChild(desc);
            comp.appendChild(textCol);
            comps.push(comp);
        }
        finalizeVariantSet(page, comps, 'Alert', 'Shadcn alert. Variant: default, destructive. Row layout with a leading icon and a stacked title (SemiBold) and description. 1px border, rounded-lg (8), padding 16, gap 12.', 1);
    });
}
function gen_alert_dialog(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        footer.paddingTop = 8;
        footer.fills = [];
        const makeButton = (label, bgToken, fgToken, borderToken) => {
            ...
            btn.resize(100, 36);
            if (bgToken) {
                const v = findVariable(bgToken);
                if (v)
                    btn.fills = [varPaint(v)];
            }
            else {
                btn.fills = [];
            }
            if (borderToken) {
                const v = findVariable(borderToken);
                if (v) {
                    btn.strokes = [varPaint(v)];
                    btn.strokeWeight = 1;
                }
            }
            const t = figma.createText();
...
function gen_avatar(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const sizes = [
...
function gen_separator(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const orientations = [
...
function gen_skeleton(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Skeleton';
        ...
        if (muted)
            line2.fills = [varPaint(muted)];
        lines.appendChild(line2);
        page.appendChild(comp);
    });
}
function gen_kbd(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Kbd';
...
function gen_empty(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Empty';
        ...
        if (primaryV)
            button.fills = [varPaint(primaryV)];
        ...
        if (primaryFgV)
            btnText.fills = [varPaint(primaryFgV)];
        button.appendChild(btnText);
        comp.appendChild(button);
        page.appendChild(comp);
    });
}
function gen_item(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Item';
        ...
        const mutedVar = findVariable('muted');
        if (mutedVar)
            iconBox.fills = [varPaint(mutedVar)];
        ...
        if (mutedFgVar)
            glyph.fills = [varPaint(mutedFgVar)];
        ...
        if (mutedFgVar)
            subtitle.fills = [varPaint(mutedFgVar)];
        ...
        if (mutedFgVar)
            chevronGlyph.fills = [varPaint(mutedFgVar)];
        chevron.appendChild(chevronGlyph);
        comp.appendChild(chevron);
        page.appendChild(comp);
    });
}
function gen_accordion(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const makeItem = (title, expanded, body) => {
            ...
            if (foregroundVar)
                titleText.fills = [varPaint(foregroundVar)];
            ...
            if (expanded) {
                ...
                if (mutedFgVar)
                    bodyText.fills = [varPaint(mutedFgVar)];
            ...
            if (borderVar)
                divider.fills = [varPaint(borderVar)];
...
function gen_tabs(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Tabs';
        ...
        if (cardBgV)
            content.fills = [varPaint(cardBgV)];
        const borderV = findVariable('border');
        if (borderV) {
            content.strokes = [varPaint(borderV)];
        ...
        if (bodyV)
            body.fills = [varPaint(bodyV)];
        content.appendChild(body);
        comp.appendChild(content);
        page.appendChild(comp);
    });
}
function gen_breadcrumb(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        const mutedVar = findVariable('muted-foreground');
        const fgVar = findVariable('foreground');
        const makeLabel = (label, current) => {
            const t = figma.createText();
            t.fontName = { family: 'Inter', style: current ? 'Medium' : 'Regular' };
            t.characters = label;
            t.fontSize = 14;
            const colorVar = current ? fgVar : mutedVar;
            if (colorVar)
                t.fills = [varPaint(colorVar)];
            return t;
        };
        const makeSeparator = () => {
            ...
            chevron.fills = [];
            if (mutedVar)
                chevron.strokes = [varPaint(mutedVar)];
...
function gen_pagination(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        const makeNavLink = (label, leading) => {
        ...
        const makePageLink = (label, active) => {
            ...
            if (active) {
                cell.fills = [];
                if (borderVar) {
                    cell.strokes = [varPaint(borderVar)];
                    cell.strokeWeight = 1;
                }
            }
            else {
        ...
        const makeEllipsis = () => {
            ...
            text.fontSize = 14;
            if (mutedFgVar)
                text.fills = [varPaint(mutedFgVar)];
            cell.appendChild(text);
            return cell;
        };
...
function gen_menubar(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Menubar';
        ...
        for (const label of labels) {
            ...
            if (label.active) {
                ...
                if (accentVar)
                    trigger.fills = [varPaint(accentVar)];
            }
            else {
                trigger.fills = [];
            }
...
function gen_navigation_menu(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        const makeChevron = (colorVar) => {
            ...
            chevron.characters = '▼';
            if (colorVar)
                chevron.fills = [varPaint(colorVar)];
            return chevron;
        };
        for (const trig of triggers) {
            ...
            if (labelColor)
                text.fills = [varPaint(labelColor)];
...
function gen_progress(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Progress';
        ...
        if (fillVar)
            indicator.fills = [varPaint(fillVar)];
        else
            indicator.fills = [];
...
function gen_spinner(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const size = 24;
        ...
        if (trackVar) {
            ring.strokes = [Object.assign(Object.assign({}, varPaint(trackVar)), { opacity: 0.25 })];
        }
...
function gen_tooltip(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Tooltip';
...
function gen_toast(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Toast';
        ...
        if (mutedVar)
            closeIcon.fills = [varPaint(mutedVar)];
        closeBtn.appendChild(closeIcon);
        comp.appendChild(closeBtn);
        page.appendChild(comp);
    });
}
function gen_collapsible(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const fg = findVariable('foreground');
        const mutedFg = findVariable('muted-foreground');
        const borderVar = findVariable('border');
        ...
        if (fg)
            triggerLabel.fills = [varPaint(fg)];
        ...
        const items = ['@radix-ui/primitives', '@radix-ui/colors', '@stitches/react'];
        for (const label of items) {
            ...
            rowText.fontSize = 14;
            if (mutedFg)
                rowText.fills = [varPaint(mutedFg)];
...
function gen_resizable(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Resizable';
        ...
        if (handleBgVar) {
            handle.fills = [varPaint(handleBgVar)];
        }
        else {
            handle.fills = [];
        }
        ...
        if (gripFillVar) {
            grip.fills = [varPaint(gripFillVar)];
        }
        else {
            grip.fills = [];
        }
        ...
        if (gripStrokeVar) {
            grip.strokes = [varPaint(gripStrokeVar)];
            grip.strokeWeight = 1;
        }
        for (let i = 0; i < 3; i++) {
            const dot = figma.createEllipse();
...
function gen_scroll_area(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        const fgVar = findVariable('foreground');
        if (fgVar)
            heading.fills = [varPaint(fgVar)];
        heading.layoutAlign = 'STRETCH';
        content.appendChild(heading);
        const rowLabels = ['v1.2.0-beta.50', 'v1.2.0-beta.49', 'v1.2.0-beta.48', 'v1.2.0-beta.47', 'v1.2.0-beta.46', 'v1.2.0-beta.45', 'v1.2.0-beta.44'];
        const mutedVar = findVariable('muted-foreground');
...
function gen_aspect_ratio(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
...
function gen_sidebar(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        comp.itemSpacing = 0;
        if (sidebarBg)
            comp.fills = [varPaint(sidebarBg)];
        if (sidebarBorder) {
            comp.strokes = [varPaint(sidebarBorder)];
            comp.strokeWeight = 1;
        }
        // ---- Header ----
        const header = figma.createFrame();
        ...
        if (sidebarFg)
            brandTitle.fills = [varPaint(sidebarFg)];
        ...
        if (mutedFg)
            brandSub.fills = [varPaint(mutedFg)];
        ...
        if (mutedFg)
            groupLabel.fills = [varPaint(mutedFg)];
        ...
        for (const item of items) {
            ...
            icon.resize(16, 16);
            icon.cornerRadius = 4;
            const iconColor = item.active ? sidebarAccentFg : sidebarFg;
            if (iconColor)
                icon.fills = [varPaint(iconColor)];
            ...
            label.fontSize = 14;
            const labelColor = item.active ? sidebarAccentFg : sidebarFg;
            if (labelColor)
                label.fills = [varPaint(labelColor)];
            label.layoutGrow = 1;
        ...
        avatar.cornerRadius = 9999;
        if (sidebarAccent)
            avatar.fills = [varPaint(sidebarAccent)];
        ...
        if (sidebarAccentFg)
            avatarText.fills = [varPaint(sidebarAccentFg)];
        ...
        if (sidebarFg)
            userName.fills = [varPaint(sidebarFg)];
        ...
        if (mutedFg)
            userMail.fills = [varPaint(mutedFg)];
...
function gen_dialog(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Dialog';
        ...
        if (overlay) {
            const overlayPaint = Object.assign(Object.assign({}, varPaint(overlay)), { opacity: 0.5 });
        ...
        if (cardBg)
            card.fills = [varPaint(cardBg)];
        const cardBorder = findVariable('border');
        if (cardBorder) {
            card.strokes = [varPaint(cardBorder)];
            card.strokeWeight = 1;
        }
        card.effects = [{
                type: 'DROP_SHADOW',
        ...
        if (closeFg)
            closeIcon.fills = [varPaint(closeFg)];
        closeBtn.appendChild(closeIcon);
        ...
        if (descFg)
            description.fills = [varPaint(descFg)];
        ...
        if (contentBorder) {
            content.strokes = [varPaint(contentBorder)];
            content.strokeWeight = 1;
        }
        ...
        if (contentLabelFg)
            contentLabel.fills = [varPaint(contentLabelFg)];
        ...
        if (contentValueFg)
            contentValue.fills = [varPaint(contentValueFg)];
        ...
        if (cancelBorder) {
            cancelBtn.strokes = [varPaint(cancelBorder)];
        ...
        if (cancelFg)
            cancelText.fills = [varPaint(cancelFg)];
        ...
        if (confirmBg)
            confirmBtn.fills = [varPaint(confirmBg)];
        ...
        if (confirmFg)
            confirmText.fills = [varPaint(confirmFg)];
...
function gen_popover(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Popover';
        ...
        description.lineHeight = { value: 20, unit: 'PIXELS' };
        if (mutedVar)
            description.fills = [varPaint(mutedVar)];
        header.appendChild(description);
        comp.appendChild(header);
        ...
        if (inputBgVar)
            input.fills = [varPaint(inputBgVar)];
        const inputBorderVar = findVariable('input');
        if (inputBorderVar) {
            input.strokes = [varPaint(inputBorderVar)];
            input.strokeWeight = 1;
        }
        ...
        if (fgVar)
            inputText.fills = [varPaint(fgVar)];
...
function gen_sheet(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Sheet';
        ...
        closeIcon.fontSize = 14;
        if (mutedFgVar)
            closeIcon.fills = [varPaint(mutedFgVar)];
        closeBtn.appendChild(closeIcon);
        ...
        desc.layoutAlign = 'STRETCH';
        if (mutedFgVar)
            desc.fills = [varPaint(mutedFgVar)];
        header.appendChild(desc);
        comp.appendChild(header);
        ...
        cancelText.fontSize = 14;
        if (fgVar)
            cancelText.fills = [varPaint(fgVar)];
        cancelBtn.appendChild(cancelText);
        footer.appendChild(cancelBtn);
        // Save (primary) button
        ...
        saveBtn.cornerRadius = 6;
        {
            const primary = findVariable('primary');
            if (primary)
                saveBtn.fills = [varPaint(primary)];
        }
        ...
        saveText.fontSize = 14;
        {
            const primaryFg = findVariable('primary-foreground');
            if (primaryFg)
                saveText.fills = [varPaint(primaryFg)];
        }
...
function gen_drawer(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Drawer';
        ...
        if (fgVar)
            bigNumber.fills = [varPaint(fgVar)];
        ...
        if (mutedFgVar)
            unit.fills = [varPaint(mutedFgVar)];
        ...
        const primaryVar = findVariable('primary');
        if (primaryVar)
            submitBtn.fills = [varPaint(primaryVar)];
        ...
        if (primaryFgVar)
            submitText.fills = [varPaint(primaryFgVar)];
...
function gen_hover_card(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        ...
        if (avatarBg)
            avatar.fills = [varPaint(avatarBg)];
        ...
        if (avatarFg)
            avatarFallback.fills = [varPaint(avatarFg)];
        ...
        if (metaFg)
            meta.fills = [varPaint(metaFg)];
        content.appendChild(meta);
        meta.layoutSizingHorizontal = 'FILL';
        page.appendChild(comp);
    });
}
function gen_dropdown_menu(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const popoverBg = findVariable('popover');
        ...
        if (popoverBg)
            panel.fills = [varPaint(popoverBg)];
        if (borderVar) {
        ...
        const makeItem = (label, opts) => {
            ...
            const fgVar = opts.destructive ? destructiveFg : opts.highlighted ? accentFg : popoverFg;
            if (opts.icon) {
                const icon = figma.createFrame();
                icon.name = 'Icon';
                icon.resize(16, 16);
...
function gen_context_menu(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        comp.cornerRadius = 6;
        if (popoverFill)
            comp.fills = [varPaint(popoverFill)];
        if (borderVar) {
            comp.strokes = [varPaint(borderVar)];
            comp.strokeWeight = 1;
        }
        const makeItem = (label, shortcut, highlighted, destructive) => {
            const item = figma.createFrame();
            item.name = label;
            item.layoutMode = 'HORIZONTAL';
            ...
            item.itemSpacing = 8;
            item.cornerRadius = 4;
            if (highlighted && accentFill) {
                item.fills = [varPaint(accentFill)];
            }
            else {
                item.fills = [];
            }
            ...
            if (destructive) {
                if (destructiveColor)
                    text.fills = [varPaint(destructiveColor)];
            }
            else if (highlighted) {
                if (accentFg)
                    text.fills = [varPaint(accentFg)];
            }
            else if (popoverFg) {
        ...
        const appendItem = (label, shortcut, highlighted, destructive) => {
...
function gen_command(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const fgVar = findVariable('foreground');
        const mutedFgVar = findVariable('muted-foreground');
        ...
        const makeIcon = (size, colorVar) => {
            ...
            icon.fills = [];
            if (colorVar) {
                icon.strokes = [varPaint(colorVar)];
                icon.strokeWeight = 1.5;
            }
            return icon;
        };
        // Helper: make a text node.
        const makeText = (chars, style, fontSize, colorVar) => {
            const t = figma.createText();
        ...
        comp.clipsContent = true;
        if (popoverVar)
            comp.fills = [varPaint(popoverVar)];
        if (borderVar) {
            comp.strokes = [varPaint(borderVar)];
            comp.strokeWeight = 1;
        }
        ...
        if (borderVar)
            separator.fills = [varPaint(borderVar)];
        else
            separator.fills = [];
        comp.appendChild(separator);
        // --- List container ---
        ...
        const makeItem = (label, shortcut, active) => {
            const item = figma.createFrame();
        ...
        if (borderVar)
            innerSep.fills = [varPaint(borderVar)];
        else
            innerSep.fills = [];
...
function gen_table(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const fgVar = findVariable('foreground');
        const mutedFgVar = findVariable('muted-foreground');
        const borderVar = findVariable('border');
        ...
        const rowHeight = 48;
        const cellPadX = 16;
        const makeCell = (value, col, isHeader) => {
            const cell = figma.createFrame();
        ...
        const makeRow = (name, isHeader, getValue) => {
            const row = figma.createFrame();
            row.name = name;
            row.layoutMode = 'HORIZONTAL';
            row.primaryAxisSizingMode = 'FIXED';
...
function gen_calendar(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Calendar';
        ...
        const makeNavButton = (glyph) => {
            ...
            btn.fills = [];
            if (borderVar) {
                btn.strokes = [varPaint(borderVar)];
                btn.strokeWeight = 1;
            }
            const t = figma.createText();
            t.fontName = { family: 'Inter', style: 'Medium' };
        ...
        if (fgVar)
            monthLabel.fills = [varPaint(fgVar)];
        ...
        for (let row = 0; row < 6; row++) {
            ...
            for (let col = 0; col < 7; col++) {
                ...
                if (data.isToday) {
                    if (primaryVar)
                        cell.fills = [varPaint(primaryVar)];
                }
                else {
                    cell.fills = [];
                }
...
function gen_chart(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        const comp = figma.createComponent();
        comp.name = 'Chart';
        ...
        barsRow.fills = [];
        const barHeights = [120, 180, 90, 150, 110, 170];
        const series = ['chart-1', 'chart-2', 'chart-3', 'chart-4', 'chart-5', 'chart-1'];
        for (let i = 0; i < barHeights.length; i++) {
            const barHeight = (_a = barHeights[i]) !== null && _a !== void 0 ? _a : 100;
            const seriesName = (_b = series[i]) !== null && _b !== void 0 ? _b : 'chart-1';
        ...
        const borderV = findVariable('border');
        if (borderV)
            axis.fills = [varPaint(borderV)];
        chartArea.appendChild(axis);
        comp.appendChild(chartArea);
        page.appendChild(comp);
    });
}
function gen_carousel(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Carousel';
        ...
        if (mutedVar)
            slide.fills = [varPaint(mutedVar)];
        if (borderVar) {
            slide.strokes = [varPaint(borderVar)];
        ...
        for (let i = 0; i < 4; i++) {
            ...
            if (i === 0) {
                if (primaryVar)
                    dot.fills = [varPaint(primaryVar)];
            }
            else {
                if (mutedFgVar)
                    dot.fills = [varPaint(mutedFgVar)];
                dot.opacity = 0.4;
            }
...
function gen_form(page, findVariable) {
    return __awaiter(this, void 0, void 0, function* () {
        const comp = figma.createComponent();
        comp.name = 'Form';
        ...
        const buildField = (labelText, placeholderText, helperText) => {
            ...
            input.resize(312, 36);
            if (bgV)
                input.fills = [varPaint(bgV)];
            if (inputBorderV) {
                input.strokes = [varPaint(inputBorderV)];
                input.strokeWeight = 1;
            }
            const placeholder = figma.createText();
            placeholder.fontName = { family: 'Inter', style: 'Regular' };
            ...
            placeholder.fontSize = 14;
            if (mutedFgV)
                placeholder.fills = [varPaint(mutedFgV)];
            input.appendChild(placeholder);
            ...
            helper.fontSize = 12;
            if (mutedFgV)
                helper.fills = [varPaint(mutedFgV)];
        ...
        const primaryFgV = findVariable('primary-foreground');
        if (primaryFgV)
            buttonText.fills = [varPaint(primaryFgV)];
        button.appendChild(buttonText);
        comp.appendChild(button);
        page.appendChild(comp);
    });
...
function generateComponent(componentName, page, findVariable, colorCollection) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const loadFontSafely = (font) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield figma.loadFontAsync(font);
            }
            catch (e) {
        ...
        yield loadFontSafely({ family: "Inter", style: "Regular" });
        yield loadFontSafely({ family: "Inter", style: "Medium" });
        yield loadFontSafely({ family: "Inter", style: "SemiBold" });
        yield loadFontSafely({ family: "Inter", style: "Bold" });
        const gen = COMPONENT_GENERATORS[componentName];
        if (!gen) {
            console.warn("No generator for component:", componentName);
            return;
        }
        yield gen(page, findVariable);
    });
}
...
function generateTailwindVariables() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            function processColor(path, value) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (typeof value === 'string') {
                        ...
                        for (const key in value) {
                            yield processColor(`${path}/${key}`, value[key]);
                        }
                    }
                });
            }
            for (const colorName in tailwindColors) {
                ...
                yield processColor(colorName, tailwindColors[colorName]);
            }
...
figma.ui.onmessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (msg.type === 'generate-variables') {
        try {
            ...
            const usedPrimitiveNames = new Set();
            ...
            const getOrCreatePrimitive = (value) => {
            ...
            yield gridPage.loadAsync();
            console.log('Grid page loaded, creating examples...');
            yield createGridExamples(gridPage);
            ...
            const tailwindColorCount = tailwindColorFamilies.reduce((acc, family) => {
                return acc + Object.keys(tailwindColors[family]).length;
            }, 0);
